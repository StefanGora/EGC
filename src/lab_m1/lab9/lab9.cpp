 ...
 */
 ...
 /*
 *   EX7 
     Dupa modificarea filtrelor din CreateRandomTexture() se observa urmatoarele lucruri:
     -> Daca folosesc filtre de GL_LINEAR blurul texturii de pe cubul din stanga va fi mai intens 
     -> Daca folosesc GL_NEAREST,textura nu va avea un blur intens. 
     -> Cel mai dominant filtru ( The Chad filter ) este cel de la GL_TEXTURE_MAG_FILTER
        pentru ca daca filtrele difera, blurul va fi dat de ce e la GL_TEXTURE_MAG_FILTER.
 */
...
void Lab9::Update(float deltaTimeSeconds)
{
...

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, mapTextures["random"], nullptr);
    }
