...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 0, 1), glm::vec3(0.3, 0.5, 0.8)),
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 0, 1), glm::vec3(0.3, 0.5, 0.8)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1, 0, 0), glm::vec3(0.3, 0.5, 0.8)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(1, 0, 0), glm::vec3(0.3, 0.5, 0.8)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 0), glm::vec3(0.3, 0.5, 0.8)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0, 1), glm::vec3(0.3, 0.5, 0.8)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0, 0), glm::vec3(0.3, 0.5, 0.8)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 0, 0), glm::vec3(0.3, 0.5, 0.8))
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices1{
            VertexFormat(glm::vec3(1, 1,  3), glm::vec3(1, 0, 1), glm::vec3(0.8, 0.6, 0.3)), //0
            VertexFormat(glm::vec3(3, 1,  5), glm::vec3(0, 0, 1), glm::vec3(0.8, 0.6, 0.3)), //1
            VertexFormat(glm::vec3(4, 1,  3), glm::vec3(1, 0, 1), glm::vec3(0.5, 0.5, 0.5)), //2
            VertexFormat(glm::vec3(3, 3,  4), glm::vec3(0, 0, 1), glm::vec3(0.5, 0.5, 0.5)) //3
...

    {
        ...
        vector<VertexFormat> vt
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 0), glm::vec3(0.5, 0.3, 0.5)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0, 0), glm::vec3(0.5, 0.3, 0.5)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 0, 1), glm::vec3(0.5, 0.3, 0.5)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 0, 1), glm::vec3(0.5, 0.3, 0.5)),
        ...
        meshes["square"]-> InitFromData(vt, it);
        // Create a new mesh from buffer data
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1, 0 , 0), glm::vec3(0.5f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-1, 0.5f, 0.3f), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 1.5f, 0), glm::vec3(0.75f));
