...
{
    {
        ...
        //Gold
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.6, 0.5, 0.3));
...

    {
        ...
        // TODO(student): Add or change the object colors
        //Silver
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.75, 0.75, 0.75));
...

    {
        ...
        //Bronze
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.8, 0.49, 0.19));
    }
